...
const SubirDeGradoEstudiante  = ({ setKeyDataGrid, handleCloseDelM, data_entrada }) => {
    ...
    const handdleSubmit = async (event) => {
      ...
      return (
        <div style={{ maxHeight: 500, overflowY: "auto", paddingTop: "7px" }}>
          <Container>
            {mostrarMensajeError&&<Alert key={keyAlert} severity="error" title="Campos Incorrectos" message={mensageDeError} />}
