...
export const add =  async (data) => axios.post("/Users/create",data, axiosCong());
export const update = async (data) => axios.put("/Users/update",data, axiosCong());
export const changepassword = async (data) => axios.put("/Users/changepassword",data, axiosCong());
export const remove =  async (id) => axios.delete(`/Users/changepassword/${id}`, axiosCong());
